...
if __name__ =="__main__":
    ...
    for epoch in range(opt.nepoch):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            hand_l, hand_r = np.split(hands, 2, axis=1)
            ...
            hand_l_input = hand_l[:,3:]
            hand_r_input = hand_r[:,3:]
            
            hand_l_input, hand_r_input= hand_l_input.cuda(), hand_r_input.cuda()
            ...
            loss_total_l , mse_l, kl_l = handvae_l.loss(hand_l_input, target = target_hand_l, beta = opt.beta)
            loss_total_r , mse_r, kl_r = handvae_r.loss(hand_r_input, target = target_hand_r, beta = opt.beta)
