...
if __name__=="__main__":
    ...
    parser.add_argument('--outf', type=str, default='sekitori', help='output folder')
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            for b in range(batchsize):
                ...
                if "bottle" in filename[b]:
                    ...
                    loss_mse_l, target_idx_l, loss_mean_l, idx_l_min_loss, all_indices_l, worst_histgram_l = sekitori(pred_l, t_l, N=opt.target_num) 
                    loss_mse_r, target_idx_r, loss_mean_r, idx_r_min_loss, all_indices_r, worst_histgram_r = sekitori(pred_r, t_r, N=opt.target_num)
