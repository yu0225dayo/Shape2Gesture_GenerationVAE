...
def plot_loss_histogram(loss_mean_target, worst_idx, prefix="", modelname="", sample_id="", epoch=1, count=""):
    """
    ...
    os.makedirs(f"Log/{modelname}/histgram/{prefix}/{sample_id}", exist_ok=True)
    save_path = f"Log/{modelname}/histgram/{prefix}/{sample_id}/epoch_{epoch:03d}_{count}.png"

    plt.savefig(save_path, dpi=150, bbox_inches="tight")
    plt.close()

def plot_sorted_loss_histogram(losses_tensor, top_k, prefix="", modelname="", sample_id="", epoch=1, count=""):
    """
    ...
    # 保存
    os.makedirs(f"Log/{modelname}/worst_histgram_sorted/{prefix}/{sample_id}", exist_ok=True)
    save_path = f"Log/{modelname}/worst_histgram_sorted/{prefix}/{sample_id}/epoch_{epoch:03d}_{count}.png"
...
def visualize_pca_dual(Z, indices1, indices2, prefix="", modelname="", sample_id="", assigned_indices=[], epoch=1, count=""):
    ...
    os.makedirs(f"Log/{modelname}/PCA_use/{prefix}/{sample_id}", exist_ok=True)
    save_path1 = f"Log/{modelname}/PCA_use/{prefix}/{sample_id}/epoch_{epoch:03d}_{count}.png"
    ...
    os.makedirs(f"Log/{modelname}/PCA_min/{prefix}/{sample_id}", exist_ok=True)
    save_path2 = f"Log/{modelname}/PCA_min/{prefix}/{modelname}/{sample_id}/epoch_{epoch:03d}_{count}.png"
    plt.savefig(save_path2, dpi=300, bbox_inches="tight")
    plt.close()
    #print(f"PCA plot saved as {save_path2}")

def visualize_pca_dual_mean(Z, indices1, indices2, prefix="", modelname="", sample_id="", assigned_indices=[], epoch=1, count=""):
    ...
    plt.xlabel("PCA 1")
    plt.ylabel("PCA 2")
    plt.title(f"PCA of Z - assigned teacher groups (epoch {epoch:03d}_{count})")
    # plt.xlim(-5, 5)
    # plt.ylim(-5, 5)
    plt.xlim(-8, 8)
    plt.ylim(-8, 8)
    ...
    plt.xlabel("PCA 1")
    plt.ylabel("PCA 2")
    plt.title(f"PCA of Z - min loss (epoch {epoch:03d}_{count})")
    plt.xlim(-8, 8)
    plt.ylim(-8, 8)
    plt.tight_layout()

    os.makedirs(f"Log/{modelname}/PCA_min/{prefix}/{sample_id}", exist_ok=True)
    save_path2 = f"Log/{modelname}/PCA_min/{prefix}/{sample_id}/epoch_{epoch:03d}_{count}.png"
    plt.savefig(save_path2, dpi=300, bbox_inches="tight")
    plt.close()
    #print(f"PCA plot saved as {save_path2}")

def all_sample_pca(all_sample_z, all_indices, modelname="", filename="zl", epoch=0):
    ...
    plt.ylim(-10, 10)
    plt.tight_layout()
    os.makedirs(f"Log/{modelname}/PCA_allsamples/{filename}", exist_ok=True)
    save_path = f"Log/{modelname}/PCA_allsamples/{filename}/epoch_{epoch:03d}.png"
    plt.savefig(save_path, dpi=300, bbox_inches="tight")
    plt.close()

def visualize_grad_bottle(grad_l_all=[], grad_r_all=[], idx_l=[], idx_r=[], modelname="", epoch=1):
    """gradを可視化"""
    ...
    plt.tight_layout()
    plt.savefig(f"Log/{modelname}/grad_histgram/bottle/hand_l/epoch_{epoch}.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"Log/{modelname}/grad_histgram/bottle/hand_r/epoch_{epoch}.png")
    plt.close()

def visualize_grad_else(grad_l_all=[], grad_r_all=[], class_name="", modelname="", epoch=1):
    ...
    plt.tight_layout()
    plt.savefig(f"Log/{modelname}/grad_histgram/{class_name}/hand_l/epoch_{epoch}.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"Log/{modelname}/grad_histgram/{class_name}/hand_r/epoch_{epoch}.png")
    plt.close()