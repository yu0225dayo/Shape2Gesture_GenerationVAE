...
相互検索システムではDBが不可欠であるため、本プロジェクトではDBなしで直接生成できる生成モデルに拡張する。<br>
...
## 結果
上段の形状を1️⃣でパーツ分割し、各パーツ形状から把持姿勢を生成した結果が以下である。
VAE構造であるため複数回サンプリングした結果を載せている。
![Model overview](figs/demo3.png)
