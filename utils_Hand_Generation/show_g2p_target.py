...
from utils_Hand_Generation.train_positionVAE_sekitori import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--select_labels', type=list, default=None, help="what class use in dataset") #["ju", "mu", "bo", "pc"]
